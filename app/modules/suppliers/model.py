...
class SupplierStateLink(SQLModel, table=True):
    ...
    state_id: int = Field(foreign_key='states.id', primary_key=True)
...
class Supplier(SQLModel, table=True):
    ...
    states: list["State"] = Relationship(back_populates="states", link_model=SupplierStateLink)
...
class State(SQLModel, table=True):
    ...
    suppliers: list["Supplier"] = Relationship(back_populates="suppliers", link_model=SupplierStateLink)
